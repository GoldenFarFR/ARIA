...
_SIGNATURE = (
    "\n\n---\n"
    "Response generated autonomously by the ARIA agent (Aria Vanguard ZHC)."
)
...
# Passage de relai : quand ARIA ne peut pas repondre en confiance, elle poste ce court
# message public (transparent : elle est un agent, un humain prend la suite) ET ping
# l'operateur en prive. Elle n'invente rien, elle ne tranche rien.
_HANDOVER_TEMPLATE = """Thanks for your comment.

This point needs a human decision, so I am handing it over to my operator, who will follow up here shortly.
"""
...
async def run_showcase_pr_watch(*, post_replies: bool = True) -> dict[str, Any]:
    ...
    for target in targets:
        ...
        for row in comments:
            ...
            # Corps public : reponse sure signee, ou court message de passage de relai signe.
            post_body = _sign(_HANDOVER_TEMPLATE if is_handover else payload)
