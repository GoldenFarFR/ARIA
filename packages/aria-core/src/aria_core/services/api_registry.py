...
def _static_entries() -> list[ApiEntry]:
    ...
    return [
        ...
        ApiEntry("GitHub API (vérification dépôt)", "Données on-chain", "https://api.github.com", True, note="sans clé, 60 req/h/IP — vérifie le contenu des liens GitHub déclarés (conviction_research.py, 19/07)"),
