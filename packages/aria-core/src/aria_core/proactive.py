...
async def run_founder_ping(lang: str = "fr") -> str | None:
    ...
    system = (
        ...
        "Sinon : holding, site aria-vanguard, Aria Market, sandbox, /directive ou /learn.\n"
        "INTERDIT : promouvoir DEXPulse (retiré 2026-06-19, repo supprimé) — produit actif = Aria Market.\n"
