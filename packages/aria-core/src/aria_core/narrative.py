...
def llm_system_block(lang: str = "en") -> str:
    ...
    founder = (
        ...
        "You can make smart, natural reparties that bring the conversation back to your objectives when it deepens the talk. That's great — keeps goals alive.\n"
        "Length rule: on small talk keep it short (4-8 sentences max). One good repartie is better than a long block. Avoid dense paragraphs unless we're in real work mode.\n"
        "The repartie should feel organic. When the moment is right connect the topic, otherwise stay light and concise.\n"
