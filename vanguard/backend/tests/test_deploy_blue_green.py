...
class TestReadEnvVar:
    """Double process heartbeat pendant la fenêtre standby du blue-green (SAPIEN/WMTX
    disparus, trading_mode bloque 8.5j -- diagnostic 14/08) -- deploy.sh doit lire le
    secret d'activation depuis .env pour l'envoyer au nouveau conteneur une fois la
    bascule confirmee. Meme doctrine anti-devinette que read_active_port."""
