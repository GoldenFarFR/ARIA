...
- 5+9 nouveaux tests (entry_signals + momentum_websocket), suite complète en cours de vérification. **Activation du gate `ARIA_MOMENTUM_WEBSOCKET_ENABLED` prévue juste après le déploiement de ce commit.**
