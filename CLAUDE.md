...
- #424 (03/09) — SCONE-bench (Claude exploits contracts autonomously): `docs/aria-learning-inbox/2026-09-03-diligence-scone-bench-anthropic-exploit-capability.md`.
- #425..#431 (03/09, detail `docs/backlog-technique.md`) — OWASP proxy-rescan gap; Birdeye (#278); Base Creator Grants; RH gas subsidy end 09/29; Pump.fun TP/SL clustering; MadeOnSol (#379); Socket.dev extensions (#192).
