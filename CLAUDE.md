...
- #406 (29/08) — résidu `geckoterminal_client` (4 sites, default param jamais déclenché) dans robinhood_pump_shadow.py/_v2 après specs/015 déployé (3806aa11) ; #269 pas littéralement satisfait pour Robinhood. (`docs/backlog-technique.md`)
