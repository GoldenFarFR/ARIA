...
Solution : règle durcie à 100% de contenu réel, plus aucune marge de pure imagination même marquée comme spéculation — aria_brain.py (décision opérateur explicite, 22/07, image de la « cellule de prison » : elle n'a que son livre à écrire, et rien d'autre que sa vraie vie à y mettre). Reste ouvert : pas de vérification automatique avant publication (option envisagée, pas retenue pour l'instant) — la règle repose sur le prompt système, pas un filtre déterministe.
